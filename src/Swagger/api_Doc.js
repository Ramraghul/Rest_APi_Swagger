...
const BaseUrlVersion = "v1";

const option = {
    definition: {
        openapi: '3.1.0',
        info: {
            title: 'REST API for Advanced level',
            description: 'This is a sample server Petstore server. You can find out more about Swagger at [Swagger](http://swagger.io) or on irc.freenode.net, #swagger. For this sample, you can use the API key `special-key` to test the authorization filters.',
            version: '1.0.0',
